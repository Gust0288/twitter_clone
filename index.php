...
<body>
    ...
    <nav>
        <div class="one" onclick="toggle_menu()">
    ...
    <div class="main_one">
        <a href="/">
            ...
            <path opacity="0.5" d="M2 12.2039C2 9.91549 2 8.77128 2.5192 7.82274C3.0384 6.87421 3.98695 6.28551 5.88403 5.10813L7.88403 3.86687C9.88939 2.62229 10.8921 2 12 2C13.1079 2 14.1106 2.62229 16.116 3.86687L18.116 5.10812C20.0131 6.28551 20.9616 6.87421 21.4808 7.82274C22 8.77128 22 9.91549 22 12.2039V13.725C22 17.6258 22 19.5763 20.8284 20.7881C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.7881C2 19.5763 2 17.6258 2 13.725V12.2039Z" stroke="#ffffff" stroke-width="1.5"/>
    ...
    <div class="main_two">
        <div class="post">
            ...
            <div class="right">
                <div>
                    <span>Nick Som</span>
                    <span class="username">@nsom</span>
                </div>
                <div class="content">
                    Can anyone explain what Charlie Kirk’s two “security guards” to his back right were doing the 
                    seconds before he was fatally shot? One grabs his cap and tugs his ear, then intently films… 
                    looking to the other, who does something blatantly odd with his arms… then the shot rings                    
                </div>
            </div>
        </div>
        <div class="post">
            <div class="left">
                <img src="images/avatar_5.jpg">
            </div>
            <div class="right">
                <div>
                    <span>Vue</span>
                    <span class="username">@vuejs</span>
                </div>
                <div class="content">
                    We just added a "Plugins Collection" to the ecosystem dropdown on http://vuejs.org. 
                    This is a curated collection of Vue libraries, utilities and components with stats 
                    and sorting, maintained by @jacobandrewsky
                    <img src="images/post_image_1.jpg">
                </div>
            </div>
        </div> 
        <div class="post">
            <div class="left">
                <img src="images/avatar_6.jpg">
            </div>
            <div class="right">
                <div>
                    <span>BBC News</span>
                    <span class="username">@BBCworld</span>
                </div>
                <div class="content">
                    North Korea executing more people for watching foreign films and TV, UN finds
                    <img src="images/post_image_2.jpg">
                </div>
            </div>
        </div>                 
    </div>
